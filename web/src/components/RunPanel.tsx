...
const PAUSE_LABEL: Readonly<Record<string, string>> = {
  approval: "已暂停，等待你确认",
  migration: "已暂停，等待迁移",
};
 ...
 */
const STOP_REASON_LABEL: Readonly<Record<string, string>> = {
  max_steps: "步数用尽",
...
function fractionOf(spent: number, ceiling: number | null): number | null {
